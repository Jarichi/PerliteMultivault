...
// Load settings from settings.php if it exists
...
if ($siteLogo and empty($customSection)) {
	$customSection = '<div class="sm-site-title">&nbsp;</div>
                                    <div class="custom-page">
					                  <img class="custom-page-logo" src="' . $basePath . $siteLogo . '" alt="Custom Logo">
					                  <div> &nbsp;</div>';
	...
	if (!empty($siteGithub)) {
		$customSection = $customSection . '
		                                  <li>
		                                    <a href="' . $siteGithub . '">
										      <img class="social-logo" src="' . $basePath . '.styles/github-color.svg" alt="Github Logo">
										    </a>
										  </li>';
	}
		...
		$customSection = $customSection . '
		                                  <li>
		                                    <a href="https://x.com/' . substr($siteTwitter, 1) . '">
										      <img class="social-logo" src="' . $basePath . '.styles/x-color.svg" alt="X Logo">
										    </a>
										  </li>';
	}
	...
	$customSection = $customSection . '
						                  <li>
	                                        <a href="' . $siteHomepage . '">
									          <img class="social-logo" src="' . $basePath . '.styles/fontawesome-color.svg" alt="Homepage Logo">
									        </a>
									      </li>
					                    </ul>';
