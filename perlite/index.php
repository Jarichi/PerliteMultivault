...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $basePath ?>.styles/app.css" type="text/css">
    <link id="highlight-js" rel="stylesheet" href="<?php echo $basePath ?>.styles/atom-one-dark.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo $basePath ?>.styles/perlite.css" type="text/css">
    <link rel="stylesheet" href="<?php echo $basePath ?>.styles/vis-network.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo $basePath ?>.styles/katex.min.css" type="text/css">
    <link rel="icon" type="image/x-icon" href="<?php echo $basePath ?>favicon.ico">

    <script src="<?php echo $basePath ?>.js/jquery.min.js"></script>
    <script src="<?php echo $basePath ?>.js/highlight.min.js"></script>
    <script src="<?php echo $basePath ?>.js/vis-network.min.js"></script>
    <script src="<?php echo $basePath ?>.js/katex.min.js"></script>
    <script src="<?php echo $basePath ?>.js/auto-render.min.js"></script>
    <script src="<?php echo $basePath ?>.js/vis-network.min.js"></script>
...
<body
        ...
        <div class="horizontal-main-container">
            <div class="workspace is-left-sidedock-open">
                <div class="workspace-ribbon side-dock-ribbon mod-left">
                    ...
                    <a href="<?php echo $basePath ?>"><img src="<?php echo $basePath ?>logo.svg" height="25" class="logo"
                            alt="Perlite Logo"></a>
    ...
    <div id="about" class="modal-container mod-dim" style="display: none">
        ...
        <div class="modal">
            ...
            <div class="modal-title"> <a href="."><img src="<?php echo $basePath ?>logo.svg" height="35"
    ...
    <script src="<?php echo $basePath ?>.js/perlite.js"></script>
</body>
